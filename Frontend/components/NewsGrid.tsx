    ...
    <section className="py-24 px-6 bg-[#141414] relative">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between mb-16 border-b border-gray-800 pb-8">
          <div>
            <h3 className="text-4xl font-display font-bold text-white mb-2">Chapter Highlights</h3>
            <p className="text-gray-400 font-mono text-sm">Latest updates from our student community</p>
          </div>
          <div className="hidden md:block">
             <button className="text-[#00df9a] text-sm font-bold uppercase tracking-wider hover:underline">All Updates</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {updates.map((update, index) => (
            ...
            >
              <div className="absolute top-0 right-0 p-4 opacity-20 text-6xl font-display font-bold text-gray-700 group-hover:text-[#00df9a] transition-colors duration-300">
                0{index + 1}
              </div>
              ...
              <h4 className="text-2xl font-display font-bold text-white mb-4 group-hover:text-[#00df9a] transition-colors duration-300">
                {update.title}
              </h4>
              ...
              <div className="flex items-center justify-between mt-auto pt-6 border-t border-gray-900">
                ...
                <button className="w-8 h-8 rounded-full border border-gray-700 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-all duration-300">
